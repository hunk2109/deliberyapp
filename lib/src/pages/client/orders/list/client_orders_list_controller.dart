...
import 'package:delibery/src/pages/client/orders/details/client_products_order_details_page.dart';
...
class ClientOrdersListController {
  ...
  Future<List<Order>>getOrders(String status) async{
    return await _orderProvider.getByStatusClient(users.id,status);
  }
  logout(){
